...
module.exports = function (collectionName, record, payload, opts) {
  ...
  this.serializeNested = function (dest, current, attribute, opts) {
    ...
    if (opts && opts.embedLinks) {
      opts.attributes = opts.attributes || []
      opts.attributes.push('links')
      dest.links = getLinks(dest, opts.embedLinks);
    }
  ...
  this.perform = function () {
    ...
    if (opts && opts.embedLinks) {
      data.links = Object.assign({}, data.links, getLinks(record, opts.embedLinks));
    }
